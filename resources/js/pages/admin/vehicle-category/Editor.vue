...
const page = usePage();
const title = (!!page.props.data.id ? "Edit" : "Tambah") + " Kategori Armada";
...
const submit = () => handleSubmit({ form, url: route('admin.vehicle-category.save') });
        ...
        <q-form class="row" @submit.prevent="submit" @validation-error="scrollToFirstErrorField">
          <q-card square flat bordered class="col">
            <q-card-section class="q-pt-md">
              ...
              <q-input autofocus v-model.trim="form.name" label="Nama Kategori" lazy-rules :error="!!form.errors.name"
